			...
			<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
				...
				<p>
					<label>Page English content </label>
				 	<textarea class="text-input textarea" name="content_en" cols="79" rows="20"></textarea>
				</p>
				<p>
					<label>Page Arabic content</label>
				 	<textarea class="text-input textarea" name="content_ar" cols="79" rows="20"></textarea>
				</p>
				<p>
